...
export function HeroSection() {
  return (
    <section className="relative h-screen flex flex-col" style={{ overflowX: "clip" }}>
      ...
      <div className="overflow-hidden mt-6 sm:mt-4 md:-mt-5 px-4 sm:px-6 md:px-8 relative z-0">
        <FadeIn as="h1" delay={0.15} y={40} className="hero-heading font-black uppercase tracking-tight leading-none whitespace-nowrap w-full text-[14vw] sm:text-[15vw] md:text-[16vw] lg:text-[17.5vw]">
          Hi, i&apos;m umair
        </FadeIn>
      </div>
      ...
      <div className="mt-auto flex justify-between items-end px-6 md:px-10 pb-7 sm:pb-8 md:pb-10 relative z-20">
        <FadeIn delay={0.35} y={20}>
          ...
          >
            a web developer &amp; cmo driven by crafting striking and unforgettable digital experiences
          </p>
        </FadeIn>
